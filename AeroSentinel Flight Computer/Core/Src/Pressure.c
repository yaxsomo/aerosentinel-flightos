...
float pressure_value, temperature_p_value;
int16_t pressure_read_state, temperature_p_state;
char pressure_sensor_buffer[100];

PressureTempData pressure_temp_data;
